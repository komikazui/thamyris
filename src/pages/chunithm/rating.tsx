...
import {
  ...
  ratingTable,
  recommendedTable,
} from "@/components/chunithm/rating-columns";
...
const ChunithmRatingFrames = () => {
  ...
  const topFumensTitle = isVerseOrAbove
    ? "Top 20 current fumen"
    : "Top 30 fumen";
              ...
              welcomeMessage={
                <div className="flex flex-col space-y-1">
                  <div className="flex flex-col">
                    ...
                    <span className="text-primary font-bold">
                      Highest Rating:{" "}
                      {((highestRating[0]?.highestRating ?? 0) / 100).toFixed(
                        2
                      ) || "Loading..."}
                    </span>
                  </div>
            ...
            {displayMode === "table" ? (
              <>
                ...
                <TableComponent
                  ...
                  columns={ratingTable}
                  onSearch={
                    isVerseOrAbove ? handleCurrentSearch : handleBaseSearch
                  }
