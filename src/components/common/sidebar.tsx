...
const chunithmSubnav: MenuItem[] = [
	{ name: "Scores", href: "/chunithm/scores", icon: NotepadText, color: "#e0d531" },
	{ name: "Userbox", href: "/chunithm/userbox", icon: Pencil, color: "#e0d531" },
	{ name: "Favorites", href: "/chunithm/favorites", icon: HeartIcon, color: "#e0d531" },
	{ name: "Rivals", href: "/chunithm/rivals", icon: Swords, color: "#e0d531" },
	{ name: "Leaderboard", href: "/chunithm/leaderboard", icon: Trophy, color: "#e0d531" },
	{ name: "All Songs", href: "/chunithm/allsongs", icon: BoomBox, color: "#e0d531" },
	{ name: "Rating Frame", href: "/chunithm/rating", icon: List, color: "#e0d531" },
];

const ongekiSubnav: MenuItem[] = [
	{ name: "Scores", href: "/ongeki/scores", icon: NotepadText, color: "#f067e9" },
	{ name: "Rivals", href: "/ongeki/rivals", icon: Swords, color: "#f067e9" },
	{ name: "Leaderboard", href: "/ongeki/leaderboard", icon: Trophy, color: "#f067e9" },
	{ name: "All Songs", href: "/ongeki/allsongs", icon: BoomBox, color: "#f067e9" },
	{ name: "Rating Frame", href: "/ongeki/rating", icon: List, color: "#f067e9" },
];

const maimaiSubNav: MenuItem[] = [
	{ name: "Scores", href: "/maimaidx/scores", icon: NotepadText, color: "#1aaeed" },
];
...
const sidebarItems: MenuItem[] = [
	...
	{ name: "News", icon: Newspaper, color: "#8B5CF6", href: "/news" },
	{
		...
		color: "#17569b",
		subnav: [
			{ name: "Chunithm", icon: ChevronDown, color: "#e0d531", subnav: chunithmSubnav },
			{ name: "Ongeki", icon: ChevronDown, color: "#f067e9", subnav: ongekiSubnav },
			{ name: "Maimai DX", icon: ChevronDown, color: "#1aaeed", subnav: maimaiSubNav },
		],
	},
];
