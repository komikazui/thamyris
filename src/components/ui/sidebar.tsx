...
import { useIsMobile } from "@/hooks/chunithm";
...
function SidebarProvider({
	...
	const setOpen = React.useCallback(
		(value: boolean | ((value: boolean) => boolean)) => {
			...
			localStorage.setItem('sidebar-open-state', JSON.stringify(openState));
		},
		[setOpenProp, open]
	);
		...
		return (
			<Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
				...
				<SheetContent
					...
					data-slot="sidebar"
					data-mobile="true"
					className="bg-sidebar text-sidebar-foreground w-(--sidebar-width) border-r-0 p-0 [&>button]:hidden"
					style={
						{
